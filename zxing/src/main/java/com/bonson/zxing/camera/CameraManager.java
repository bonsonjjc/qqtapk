package com.bonson.zxing.camera;
...
import com.bonson.zxing.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public Rect getFramingRectInPreview() {
        if (framingRectInPreview == null) {
            ...
            rect.left=cameraResolution.y/4;
            rect.right=cameraResolution.y-rect.left;
            rect.top=cameraResolution.x/2-rect.left;
            rect.bottom=cameraResolution.x/2+rect.left;
//            Point screenResolution = configManager.getScreenResolution();
