...
public interface ApiServer {
    ...
    @POST("data.html")
    Observable<List<Baby>> baby(@Body Object o);
    ...
    @POST("data.html")
    Observable<Index> device(@Body Object boj);
    ...
    @POST("data.html")
    Observable<List<Base>> ring(@Body Object boj);
...
//    @Encode(encoder = true, decoder = true)
    ...
    @POST("data.html")
//    @Encode(encoder = true, decoder = true)
    Observable<List<UserBean>> user(@Body Object requestBody);
}
