...
@Module public abstract class CenterModule {
  @ActivityScope @Binds abstract AndroidViewModel viewModel(CenterViewModel centerViewModel);

  @ActivityScope @Provides static List<Message> providesCenter() {
  ...
  @ActivityScope @Provides static CenterAdapter providesAdapter(Context context) {
    return new CenterAdapter(context, new ArrayList<>());
  }
}
