...
@ActivityScope
public class LimitFragment extends BaseFragment<FragmentLimitBinding> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        setBindingLayout(inflater, R.layout.fragment_limit, container);
        binding.setViewModel(viewModel);
        setViewModel(viewModel);

        binding.toolbar.getTvLeft().setOnClickListener(v -> back());
        binding.tvTimeOne.setOnClickListener(v -> showFirst());
        binding.tvTimeTwo.setOnClickListener(v -> showSecond());
