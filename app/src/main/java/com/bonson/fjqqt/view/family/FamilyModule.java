package com.bonson.fjqqt.view.family;
...
public abstract class FamilyModule {
    ...
    @Provides
    @ActivityScope
    static FamilyDataSource providesDataSource(FApiServer fApiServer, UserDao userDao) {
        return new FamilyModel(fApiServer,userDao);
    }
